...
// 		    EnzoTopComm, (MPI_Request *) id_recv_x0l) != 0) {
...
// 		    EnzoTopComm, (MPI_Request *) id_recv_x0r) != 0) {
...
// 		    EnzoTopComm, (MPI_Request *) id_recv_x1l) != 0) {
...
// 		    EnzoTopComm, (MPI_Request *) id_recv_x1r) != 0) {
...
// 		    EnzoTopComm, (MPI_Request *) id_recv_x2l) != 0) {
...
// 		    EnzoTopComm, (MPI_Request *) id_recv_x2r) != 0) {
...
// 		    EnzoTopComm, (MPI_Request *) id_send_x0l) != 0) {
...
// 		    EnzoTopComm, (MPI_Request *) id_send_x0r) != 0) {
...
// 		    EnzoTopComm, (MPI_Request *) id_send_x1l) != 0) {
...
// 		    EnzoTopComm, (MPI_Request *) id_send_x1r) != 0) {
...
// 		    EnzoTopComm, (MPI_Request *) id_send_x2l) != 0) {
...
// 		    EnzoTopComm, (MPI_Request *) id_send_x2r) != 0) {
...
int EnzoVector::exchange_start_component(int ivar)
{
  ...
  if (Nbors[0][0] != MPI_PROC_NULL) {
    if (MPI_Irecv(RecvBufX0l_comp, x0Lrecvsize_comp, FDataType, 
		  ...
		  EnzoTopComm, (MPI_Request *) id_recv_x0l_comp) != 0) {
  ...
  if (Nbors[0][1] != MPI_PROC_NULL) {
    if (MPI_Irecv(RecvBufX0r_comp, x0Rrecvsize_comp, FDataType, 
		  ...
		  EnzoTopComm, (MPI_Request *) id_recv_x0r_comp) != 0) {
  ...
  if (Nbors[1][0] != MPI_PROC_NULL) {
    if (MPI_Irecv(RecvBufX1l_comp, x1Lrecvsize_comp, FDataType, 
		  ...
		  EnzoTopComm, (MPI_Request *) id_recv_x1l_comp) != 0) {
  ...
  if (Nbors[1][1] != MPI_PROC_NULL) {
    if (MPI_Irecv(RecvBufX1r_comp, x1Rrecvsize_comp, FDataType, 
		  ...
		  EnzoTopComm, (MPI_Request *) id_recv_x1r_comp) != 0) {
  ...
  if (Nbors[2][0] != MPI_PROC_NULL) {
    if (MPI_Irecv(RecvBufX2l_comp, x2Lrecvsize_comp, FDataType, 
		  ...
		  EnzoTopComm, (MPI_Request *) id_recv_x2l_comp) != 0) {
  ...
  if (Nbors[2][1] != MPI_PROC_NULL) {
    if (MPI_Irecv(RecvBufX2r_comp, x2Rrecvsize_comp, FDataType, 
		  ...
		  EnzoTopComm, (MPI_Request *) id_recv_x2r_comp) != 0) {
  ...
  if (Nbors[0][1] != MPI_PROC_NULL) {
    ...
    if (MPI_Isend(SendBufX0l_comp, x0Rsendsize_comp, FDataType, 
		  ...
		  EnzoTopComm, (MPI_Request *) id_send_x0l_comp) != 0) {
  ...
  if (Nbors[0][0] != MPI_PROC_NULL) {
    ...
    if (MPI_Isend(SendBufX0r_comp, x0Lsendsize_comp, FDataType, 
		  ...
		  EnzoTopComm, (MPI_Request *) id_send_x0r_comp) != 0) {
  ...
  if (Nbors[1][1] != MPI_PROC_NULL) {
    ...
    if (MPI_Isend(SendBufX1l_comp, x1Rsendsize_comp, FDataType, 
		  ...
		  EnzoTopComm, (MPI_Request *) id_send_x1l_comp) != 0) {
  ...
  if (Nbors[1][0] != MPI_PROC_NULL) {
    ...
    if (MPI_Isend(SendBufX1r_comp, x1Lsendsize_comp, FDataType, 
		  ...
		  EnzoTopComm, (MPI_Request *) id_send_x1r_comp) != 0) {
  ...
  if (Nbors[2][1] != MPI_PROC_NULL) {
    ...
    if (MPI_Isend(SendBufX2l_comp, x2Rsendsize_comp, FDataType, 
		  ...
		  EnzoTopComm, (MPI_Request *) id_send_x2l_comp) != 0) {
  ...
  if (Nbors[2][0] != MPI_PROC_NULL) {
    ...
    if (MPI_Isend(SendBufX2r_comp, x2Lsendsize_comp, FDataType, 
		  ...
		  EnzoTopComm, (MPI_Request *) id_send_x2r_comp) != 0) {
